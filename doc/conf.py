...
# -*- coding: utf-8 -*-
#
# obsweatherscale documentation build configuration file, created by
...
version = version("obsweatherscale")
...
texinfo_documents = [
    (master_doc, 'obsweatherscale',
     u'obsweatherscale Documentation', author,
     'obsweatherscale',
