        ...
        **kwargs : Any
        ...
        if lengthscale is not None:
            rbf_kernel.raw_lengthscale = nn.Parameter(
                rbf_kernel.raw_lengthscale_constraint.inverse_transform(lengthscale), requires_grad=train_lengthscale)
        ...
        if variance is not None:
            self.kernel.raw_outputscale = nn.Parameter(
                self.kernel.raw_outputscale_constraint.inverse_transform(variance), requires_grad=train_variance)
